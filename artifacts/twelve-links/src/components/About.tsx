...
export default function About() {
  ...
  const team = [
    ...
    { name: "Mpoka J.", role: "Software Engineer & Project Lead", bio: "Guiding the development lifecycle and crafting intuitive, high-performance user interfaces that bring product vision to life.", color: "from-blue-500 to-indigo-700" , image: "/team/jackyn.png" },
