...
export default function About() {
  ...
  const team = [
    ...
    { name: "George L.", role: "Security Architect", bio: "Designing robust end-to-end security frameworks and governance protocols to ensure ultimate platform compliance and integrity.", color: "from-pink-500 to-rose-700" , image: "/team/ghost.jpeg" },
    ...
    { name: " Aphane S.", role: "Data Scientist", bio: "Extracting actionable insights from complex datasets and building predictive models to optimize platform growth and user engagement.", color: "from-teal-500 to-green-700" , image: "/team/zila.jpg" }
  ];
