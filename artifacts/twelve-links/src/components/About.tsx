...
export default function About() {
  ...
  const team = [
    { name: "Nkotwane N.", role: "Data Scientist & CEO", bio: "Visionary leader driving Africa's tech revolution, leveraging data science to bridge the gap between potential and opportunity.", color: "from-green-500 to-emerald-700" },
    { name: "Ngwenya N.", role: "AI Engineer & CTO", bio: "Architect of scalable systems, designing the intelligent models and technical backbone of the 12 Links platform.", color: "from-yellow-400 to-orange-600" },
