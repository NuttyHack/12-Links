...
export default function About() {
  ...
  const team = [
    ...
    { name: "Mpoka J.", role: "Software Engineer & Project Lead", bio: "Guiding the development lifecycle and crafting intuitive, high-performance user interfaces that bring product vision to life.", color: "from-blue-500 to-indigo-700" , image: "/team/jacky2.png" },
    ...
    { name: "Mpayipheli S.", role: "Software Developer & HOP", bio: "Building highly interactive, seamless client-side applications while forging strategic external partnerships and affiliate networks to drive platform expansion", color: "from-red-500 to-orange-600" , image: "/team/Savuzwa.png" },
